      ...
      <nav className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/matches" className="text-white hover:text-orange-400 transition-colors text-lg font-bold">
              {isRTL ? 'المباريات' : 'Matches'}
            </Link>
            <Link href="/table" className="text-white hover:text-orange-400 transition-colors text-lg font-bold">
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-gray-600 bg-slate-900 rounded-lg shadow-lg">
            <div className="flex flex-col space-y-5 pt-4 px-4">
              ...
              <Link href="/matches" className="text-white hover:text-orange-400 transition-colors text-lg font-bold py-2 rounded">
                {isRTL ? 'المباريات' : 'Matches'}
              </Link>
              <Link href="/table" className="text-white hover:text-orange-400 transition-colors text-lg font-bold py-2 rounded">
                {isRTL ? 'الترتيب' : 'Standings'}
              </Link>
